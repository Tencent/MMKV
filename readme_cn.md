...
更详细的使用教程参考 [iOS Tutorial](iOS_tutorial)。

### 性能对比
![](http://imgcache.oa.com/photos/31601/3b5a30acb12158f3a3de668452b4bac0.jpg)
更详细的性能对比参考 [iOS Benchmark](iOS_benchmark)。
...
更多安装指引参考 [Android Setup](android_setup)。
...
```
MMKV 支持**多进程访问**，更详细的用法参考 [Android Tutorial](android_tutorial)。

### 性能对比
![](http://imgcache.oa.com/photos/31601/o_bb215f7fd392321793e6564128d4bd03.jpg)

更详细的性能对比参考 [Android Benchmark](android_benchmark)。
